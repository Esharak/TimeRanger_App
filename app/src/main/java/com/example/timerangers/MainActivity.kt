...
import com.example.timerangers.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val NavBtn = findViewById<Button>(R.id.menuButton)
    ...
    private fun resetTimer()
    {
        stopTimer()
        time = 0.0
        binding.tvStopwatch.text = getTimeStringFromDouble(time)
    }
